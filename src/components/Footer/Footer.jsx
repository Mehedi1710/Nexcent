...
const Footer = () => {
  return (
    <div className="bg-[#263238] py-[64px]">
      <div className="max-w-container mx-auto">
        <div className="md:flex gap-x-[125px] mx-2 md:mx-0">
          <div className="w-[350px]">
            <div>
              <img src={logo} alt="" />
            </div>
            <div className="py-[40px]">
              <p className="text-[14px] text-[#F5F7FA] font-inter">
          ...
          <div className="hidden md:flex w-[635px]">
            <div className="flex gap-x-[30px]">
              <div className="w-[160px]">
                <h3 className="text-[20px] text-[#FFFFFF] font-inter font-semibold pb-6 ">
                  Company
                </h3>
                <p className="text-[#F5F7FA] text-[14px] font-inter pb-3">
                  About us
                </p>
                <p className="text-[#F5F7FA] text-[14px] font-inter pb-3">
                  Blog
                ...
                <p className="text-[#F5F7FA] text-[14px] font-inter">
                  Testimonials
                </p>
              </div>
              <div className="w-[160px]">
                ...
                <p className="text-[#F5F7FA] text-[14px] font-inter">Status</p>
              </div>
              <div>
                <h3 className="text-[20px] text-[#FFFFFF] font-inter font-semibold pb-6 ">
                  Stay up to date
                </h3>
                <div className="bg-[#D9DBE1] flex items-center gap-x-[80px] border border-[#D9DBE1] rounded-[8px] p-[11px] opacity-60">
            ...
            <div className="md:hidden grid grid-cols-2 gap-x-[30px] pt-6">
              <div className="">
                <h3 className="text-[20px] text-[#FFFFFF] font-inter font-semibold pb-6 ">
                  Company
                </h3>
              ...
              <div className='pt-8 w-[241px]'>
                <h3 className="text-[20px] text-[#FFFFFF] font-inter font-semibold pb-2 ">
                  Stay up to date
                </h3>
                <div className="bg-[#D9DBE1] flex items-center gap-x-[80px] border border-[#D9DBE1] rounded-[8px] p-[11px] opacity-60">
                  <p className="text-[14px] text-white font-inter">
